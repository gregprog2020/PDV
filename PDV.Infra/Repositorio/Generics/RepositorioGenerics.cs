...
namespace PDV.Infra.Repositorio.Generics
{
    public class RepositorioGenerics<T> : InterfaceGeneric<T>, IDisposable where T : class
    {
        private readonly DbContextOptions<PdvDbContext> _OptionsBuilder;

        public RepositorioGenerics() 
        {
            _OptionsBuilder = new DbContextOptions<PdvDbContext>();
        }
